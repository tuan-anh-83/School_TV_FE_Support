...
import { Video, Eye, Clock, Download, Info, ChevronDown } from "lucide-react";
import "./AdsStatisticsPage.css";
    ...
    <div className={`stats-page ${isDarkMode ? "dark-mode" : ""}`}>
      <header className="stats-page-header">
        <div className="stats-header-left">
          ...
          <span className="stats-channel-name">Advertisement Studio</span>
        </div>
              ...
              <Card
                ...
                cover={
                  <div style={thumbnailContainerStyle}>
                    <img
                      alt=""
                      src={getThumbnailUrl(extractVideoId(ad.videoUrl))}
                      style={{
                        width: "100%",
                        height: "157px",
                        objectFit: "cover",
                  ...
                  >
                    <div>
                      <Text type="secondary" style={{ fontSize: "12px" }}>
                        ...
                        {formatNumber(0)} lượt xem •{" "}
                        {dayjs(ad.createdAt).format("DD-MM-YYYY HH:mm:ss")}
                      </Text>
                    </div>
                  </div>
