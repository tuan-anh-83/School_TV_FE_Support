...
import "./AdsRegister.scss";
import apiFetch from "../../config/baseAPI";

function AdsRegister() {
  ...
  const validateForm = () => {
    ...
    if (!formData.fullname) {
      newErrors.fullname = "Vui lòng nhập tên đơn vị";
    }

    if (!formData.address) {
      newErrors.address = "Vui lòng nhập địa chỉ đơn vị";
    }
        ...
        {!showOtpVerification ? (
          <>
            <div className="school-register-header">
              ...
              <h1>Đăng ký tài khoản Nhà quảng cáo</h1>
            </div>

            <p className="school-register-description">
              Tạo tài khoản đơn vị quảng cáo để cung cấp dịch vụ nội dung và
              chương trình quảng cáo trên nền tảng SchoolTV
            </p>
            ...
            <form onSubmit={handleSubmit} className="school-register-form">
                  ...
                  <div className="school-register-field">
                    ...
                    <div className="school-register-input-wrapper">
                      ...
                      <input
                        ...
                        placeholder="Tên đăng nhập của đơn vị"
              ...
              <div className="school-register-field">
                ...
                <div className="school-register-input-wrapper">
                  ...
                  <input
                    ...
                    placeholder="Địa chỉ của đơn vị"
              ...
              <div className="school-register-terms">
                <label className="school-register-terms-checkbox">
                  ...
                  <span>
                    ...
                    >
                      Điều khoản và Điều kiện dành cho Nhà quảng cáo
                    </span>
                  </span>
                </label>
              </div>
              ...
              <div className="school-register-footer">
                <div className="school-register-login">
                  <span>Đã có tài khoản đơn vị quảng cáo?</span>
                  <Link
                    to="/school-login"
